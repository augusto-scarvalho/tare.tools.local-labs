# BACKLOG-CTRL01-REAL-TOKEN-02 preregistration

Task: Requalify CTRL-01 on real model token streams and reproduced nested controls
...
- `runs/research/BACKLOG-CTRL01-REAL-TOKEN-01/ABORTED.md`
...
- Aborted predecessor record SHA-256: `ad1ba0eaea6b0b63b0422d51636808fa358d5b2d530fd320a38c4b52c552616c`.
...
```powershell
python tools/research/run_ctrl01_real_token_r2.py --outdir runs/research/BACKLOG-CTRL01-REAL-TOKEN-02
```
...
- The nested-object and nested-array false-blocks were reproduced before this successor was admitted; their expected outcomes are frozen as unit controls, not acceptance thresholds selected from the live run.
...
- `CTRL01_FALSE_POSITIVE_CONFIRMED_R2`
