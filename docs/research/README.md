...
- [`../HANDOFF_2026-08-27_INDEPENDENT_AUDIT_QUEUE.md`](../HANDOFF_2026-08-27_INDEPENDENT_AUDIT_QUEUE.md): historical 80-record manifest and ordered 43-packet independent-audit queue, retained for review provenance and successor-chain context.
...
- [`BACKLOG_IMPLEMENTATION_PIPELINE.md`](BACKLOG_IMPLEMENTATION_PIPELINE.md): fail-closed executable queue, state machine, receipt schema, frozen-gate recalculation and provider-neutral independent-review workflow.
- [`EXPERIMENT_WATCHER.md`](EXPERIMENT_WATCHER.md): complete operator reference for the experiment launcher/watcher, progress contracts, persisted schemas, continuous-mode handoff, failure matrix, token-efficient polling, fixtures, live canary and known limitations.
