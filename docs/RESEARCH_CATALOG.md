...
| **Qualified model fleet gateway** | `QUALIFIED-MODEL-FLEET` | Can agents discover and select every role-qualified local model through one canonical endpoint without overlapping generation models in VRAM? | Evidence-bound registry; one public gateway; per-model frozen binaries/arguments; stop-before-start private backend; six sequential identity canaries; CLI discovery and recommendation. | **ACTIVE / QUALIFIED ROUTES** | Six bounded routes are exposed on 8080; cold switches measured 5.03–18.05 s; Qwen restored resident; embeddings stayed on the same PID. HOLD/rejected artifacts fail registry admission. | [`RESULT.md`](file:///C:/projects/tare.tools.local-labs/runs/serving/QUALIFIED-MODEL-FLEET-2026-08-26/RESULT.md) |
...
| **RWKV7 official recurrent checkpoint** | `RNN-10` | Does an official small constant-state checkpoint run correctly, fit, and clear a serving-quality floor on the RTX 3090? | Manifest-bound BF16 RWKV7 1.5B; recurrent parity/state gates; publisher-license revalidation; frozen 48-item normal-QA gate. | **LICENSE UNBLOCKED / HOLD QUALITY** | 3.06 GB allocated, exact cached-continuation parity, invariant 12.8 MB state, and publisher Apache-2.0. Quality was only 13/48 (math 0/10, reading 0/8), so no serving stack was installed. | [`Mechanism`](file:///C:/projects/tare.tools.local-labs/runs/requalification/RWKV7-1.5B-20260805-2026-08-22/RESULT.md), [`quality`](file:///C:/projects/tare.tools.local-labs/runs/requalification/RWKV7-SERVING-QUALITY-2026-08-24/RESULT.md) |
...
| **Host/WSL serving optimization** | `HOST-WSL-TUNE` | Can a current canonical engine and bounded runtime profiles improve decode while preserving host reserve and embeddings? | Matched 131k build A/B; context/MTP/ubatch envelope; embedding GPU/CPU control; service restore. | **BUILD QUALIFIED / NO SWITCH** | b10165 improved long decode 8.76% with prompt regression inside 3%; 43,008 was the largest tested 4 GiB-reserve context with embeddings. CPU embedding offload recovered too little VRAM. | [`RESULT.md`](file:///C:/projects/tare.tools.local-labs/runs/optimization/HOST-WSL-TUNE-2026-08-23/RESULT.md) |
| **Fable-TC persistent serve** | `FABLE-TC-SERVE` | Can the qualified concise/uncensored merge become the persistent local default without disturbing embeddings? | Versioned b10159 runtime; model/binary hashes; health/chat/MTP/embedding/restart/GPU checks; retained rollback. | **PROMOTED / ACTIVE** | Fable-TC serves on 8080 at 8k with native MTP n4; deterministic 128-token canary reached 77.11 tok/s. Embedding 8081 remained independent. | [`RESULT.md`](file:///C:/projects/tare.tools.local-labs/runs/serving/FABLE-TC-SERVE-2026-08-23/RESULT.md) |
| **HauhauCS Aggressive Qwen3.8** | `LAB-QWEN38-HAUHAUCS` | Is a less-aligned Qwen3.8 candidate smarter than Fable while remaining viable on the RTX 3090? | Revision/signature binding; HumanEval+ 60; refusal, context, native-MTP, normal QA, agent core, and GSM8K-200 gates. | **QUALIFIED CODING ROLE / NOT DEFAULT** | 56/60 HumanEval+, 44/44 comply, 131k fit, agent core 8/8. GSM8K was 191/200 with 8 truncations versus Fable 195/200 with none; FastMTP stopped before install. | [`Primary`](file:///C:/projects/tare.tools.local-labs/runs/requalification/QWEN38-HAUHAUCS-AGGRESSIVE-2026-08-23/RESULT.md), [`agent`](file:///C:/projects/tare.tools.local-labs/runs/requalification/QWEN38-AGENT-REGRESSION-2026-08-24/RESULT.md), [`math`](file:///C:/projects/tare.tools.local-labs/runs/requalification/QWEN38-HAUHAUCS-MATH-2026-08-24/RESULT.md) |
| **HauhauCS PT-BR locale control** | `LAB-QWEN38-LOCALE` | Can a generic client contract close Portuguese drift without a risky weight edit? | Separate 48-task dev/test panels; frozen prompt selection; matched Fable test; immutable grader correction receipt; loopback proxy. | **PROMOTE CONTRACT / NO WEIGHT EDIT** | Selected v2 scored 48/48 HauhauCS dev and 48/48 for both HauhauCS and Fable on blind test. Loopback OpenAI proxy on 8082 injects the contract. | [`RESULT.md`](file:///C:/projects/tare.tools.local-labs/runs/requalification/QWEN38-HAUHAUCS-LOCALE-CONTROL-2026-08-23/RESULT.md) |
...
| **BeeLlama/runtime/PEFT intake** | `BEE-L0 / SLX-01A / SLX-02A / ADAPT-00 / BEE-L2` | Which transcript proposals survive pinned-source archaeology, current local evidence, and cheap dependency gates? | Read-only fork/source audit; lifecycle-gap inventory; RTX 3090 APEX4 build/artifact preflight; frozen 0.8B seven-geometry loss/retention screen plus behavioral finalists; codec-independent KV contract. | **INTAKE EXECUTED / NO PEFT PROMOTION / NO RUNTIME PORT** | BeeLlama whole-fork import rejected; receipt gap confirmed; APEX4 checkpoint was internally truncated; LoKr led the mechanics screen and improved exact target behavior from 4/32 to 15/32, but missed correctness and EOS floors; KV execution awaits a physical candidate. | [`Analysis`](file:///C:/projects/tare.tools.local-labs/docs/research/BEELLAMA_SLOP_PEFT_ANALYSIS_2026-08-24.md), [`ADAPT-00C`](file:///C:/projects/tare.tools.local-labs/runs/research/ADAPT-00C-BEHAVIORAL-2026-08-24/RESULT.md), [`Closeout`](file:///C:/projects/tare.tools.local-labs/docs/EXECUTION_CLOSEOUT_2026-08-24_25.md) |
