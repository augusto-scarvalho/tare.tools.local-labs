...
| **HauhauCS Aggressive Qwen3.8** | `LAB-QWEN38-HAUHAUCS` | Is a less-aligned Qwen3.8 candidate smarter than Fable while remaining viable on the RTX 3090? | Revision/signature binding; HumanEval+ 60; 44-prompt refusal panel; 32k/131k context; native-MTP speed; three-model normal QA. | **QUALIFIED / NOT DEFAULT** | 56/60 HumanEval+ vs Fable 53/60; 44/44 comply vs vanilla 24/44; 131k and 72k needle pass; 91.37 tok/s. Raw PT QA exposed language drift. | [`RESULT.md`](file:///C:/projects/tare.tools.local-labs/runs/requalification/QWEN38-HAUHAUCS-AGGRESSIVE-2026-08-23/RESULT.md) |
