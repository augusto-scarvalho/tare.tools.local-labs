...
### A5. Trained EAGLE-family draft (DFlash / DSpark / Eagle3) as an alternative to the native MTP head — §35 (sibling of S3/A1) — **⏳ step-2 EXECUTED 2026-08-06: cherry-pick landed; DSpark BLOCKED on VLM targets (arch-incompat, not config); lever narrowed to text dense/MoE where native MTP already captures it.**
