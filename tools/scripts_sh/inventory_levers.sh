...
cd /home/augus/src/llama.cpp-rebase 2>/dev/null && {
...
cd /home/augus/src/llama.cpp-stack 2>/dev/null && {
  echo "branch: $(git rev-parse --abbrev-ref HEAD)   HEAD: $(git log --oneline -1)"
...
cd /home/augus/src/llama.cpp-master && for r in llama.cpp-rebase llama.cpp-stack; do
